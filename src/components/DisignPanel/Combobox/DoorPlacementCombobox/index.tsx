...
import { placementList, placementListForLeanTo } from "assets/dataList";
...
export const DoorPlacementCombobox = ({
  ...
  const { width, basicLength, bayLength, length, eaveHeight } = useStoreSize();
  ...
  const placementDataList =
    currentItem.building === ""
      ? placementList
      : currentItem.building === "Main building"
        ? placementList
        : placementListForLeanTo;
              ...
              switch (currentItem.building) {
                ...
                default:
                  switch (
                    placement[
                      Number(
                        currentItem.building[currentItem.building.length - 1],
                      ) - 1
                    ]
                  ) {
                    case "Left Endwall":
                        ...
                        case "Left Endwall":
                          ...
                          doorData.filter((item) => {
                            if (
                              ...
                              item.building === currentItem.building
                            ) {
                              points.push(
                                item.pos[2] - item.size[0] / 2,
                                item.pos[2] + item.size[0] / 2,
                          ...
                          points.push(basicLength / 2 + 0.6);
                          points.push(
                            currentLeanTo.lWidth + basicLength / 2 - 0.6,
                          );
                          points.sort(function (a, b) {
                            return a - b;
                          });
                          ...
                          for (let i = 0; i <= count * 2 + 1; i += 2) {
                            if (points[i + 1] - points[i] > movableInfo.width) {
                              if (
                                movableInfo.height < currentLeanTo.lEaveHeight
                              ) {
                                const tempPositionRange = { ...positionRange };
                                  ...
                                  tempDoorData.push({
                                    ...
                                    pos: [
                                      ...
                                      doorType === "Window"
                                        ? 7.3 - movableInfo.height / 2
                                        : movableInfo.height / 2,
                                      basicLength / 2 + currentLeanTo.lWidth,
                                    ],
                                    rot: [0, 0, 0],
                                  });
                    ...
                    case "Back Sidewall":
                      ...
                      switch (event.val) {
                        case "Left Endwall":
                          ...
                          points.push(
                            -width / 2 - currentLeanTo.lWidth / 2 + 0.6,
                          );
                          points.push(
                            -width / 2 + currentLeanTo.lWidth / 2 - 0.6,
                          );
                    ...
                    case "Front Sidewall":
                      ...
                      switch (event.val) {
                        case "Right Endwall":
                          ...
                          points.push(width / 2 + 0.6);
                          points.push(width / 2 + currentLeanTo.lWidth - 0.6);
                          points.sort(function (a, b) {
                            return a - b;
                          });
                              ...
                              if (
                                ...
                                if (filterdDoorData.length > 0) {
                                  ...
                                  tempDoorData.push({
                                    ...
                                    pos: [
                                      points[i] + movableInfo.width / 2 + 0.1,
                                      doorType === "Window"
                                        ? 7.6 - movableInfo.height / 2
                                        : movableInfo.height / 2,
                                      currentLeanTo.lPos[2] -
