...
interface ISingleSlopeSculpturedRake {
...
export const SingleSlopeSculpturedRake = ({
  pos,
  rot,
  vec,
  trimLength,
  ...
  posZ,
  deltaOverHangEave = 0,
}: ISingleSlopeSculpturedRake) => {
  const hegith = direction ? -0.5 : 0.5;
  ...
  return (
    ...
    >
      <mesh
        castShadow
        receiveShadow
        position={[0, -0.2, hegith + posZ + deltaOverHangEave]}
      >
        <Geometry>
          <Addition>
          ...
          <Subtraction
            ...
            rotation={[0, direction ? Math.PI / 2 : -Math.PI / 2, 0]}
          >
            <extrudeGeometry
              args={[
                SliceBox,
          ...
          <Subtraction
            ...
            rotation={[0, direction ? Math.PI / 2 : -Math.PI / 2, Math.PI]}
          >
            <extrudeGeometry
              args={[
                SliceBox,
          ...
          <Subtraction
            position={
              direction ? [0, -0.95, trimLength + 0.1] : [0, -0.97, 0.3]
            }
          >
            <boxGeometry args={[1, 1, 1.5]} />
          </Subtraction>
          <Subtraction
            position={direction ? [0, -0.95, 0.7] : [0, -0.97, trimLength]}
          >
            <boxGeometry args={[1, 1, 1.5]} />
          </Subtraction>
        </Geometry>
